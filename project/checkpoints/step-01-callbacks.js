/**
 * Step 1 — the whole importer, in callback style.
 *
 *   node checkpoints/step-01-callbacks.js
 *   node checkpoints/step-01-callbacks.js readings-broken.json
 *
 * Everything works. That is the uncomfortable part: this code is correct and
 * still unpleasant. Count the levels of indentation, and count how many times
 * the words `if (err)` appear.
 */
...
/**
 * An asynchronous loop, in callback style, is a recursive function.
 * There is no other way to do it: `for` cannot wait.
 */
